...
#azimuth: expected
python3 doFftAzFromRange.py rangeMatrix.txt --output azMatrix.txt --doshift yes --round_int16 yes --calibrate no
python3 plotterAzimuth.py azMatrix.txt --output figs/expectedAzMap.png  --dB yes --from_row 0 --to_row 256 # to see 1 chirp only

#azimuth: radar
python3 parserAzimuth.py azimuthCalRaw.txt --output radarAzMatrix.txt
